...
Frogger.Image = (function(Frogger) {
    ...
    // off the edge of the sprite map so a transparent block is actually drawn to the
    // canvas rather than any image. We can still take advantage of the other features of
    // the ImageSprite "class", however, to simplify collision checking later on, which
    // will tell us when the player's character has reached a goal
    Goal.prototype = new Frogger.ImageSprite();
    Goal.prototype.constructor = Goal;
    Goal.prototype.spriteLeft = -80;
    Goal.prototype.spriteTop = -80;
