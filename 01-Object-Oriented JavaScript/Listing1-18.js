...
var Accommodation = (function() {
    ...
    // Create a ‘setter’ function to allow public write-only access to the ‘alarmMessage’
...
house.alarm();       // error! The ‘alarm’ method was never exposed publicly so it’s not
                     //  available directly to any object instance created from the class

alert(house.isLocked);// undefined (‘isLocked’ is private and cannot be accessed outside
                      //  the closure)

house.getIsLocked(); // true (returns the value of the ‘isLocked’ variable, but doesn’t allow
